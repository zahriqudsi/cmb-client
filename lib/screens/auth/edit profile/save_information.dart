...
class SaveInformation extends StatefulWidget {
  ...
  const SaveInformation({Key? key, required this.authToken}) : super(key: key);

  @override
  _SaveInformationState createState() => _SaveInformationState(authToken : authToken);
}

class _SaveInformationState extends State<SaveInformation> {
  final TokenModel authToken;

    _SaveInformationState({required this.authToken});
