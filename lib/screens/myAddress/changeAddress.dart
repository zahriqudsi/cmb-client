...
class ChangeAddressScreen extends StatefulWidget {
  ...
  ChangeAddressScreen({Key? key, required this.authToken, this.callback})
      : super(key: key);

  @override
  _ChangeAddressScreenState createState() =>
      _ChangeAddressScreenState(authToken: authToken, callback: this.callback);
}
...
class _ChangeAddressScreenState extends State<ChangeAddressScreen> {
  ...
  _ChangeAddressScreenState({required this.authToken, this.callback});
                        ...
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => EditAddress(
                                authToken: authToken, addressItem: addressItem),
                          ),
                        );
                      },
                      child: Text("Edit"),
